    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                <h1 class="mb-1 font-medium">Register Account</h1>
                <form action="<?php echo e(route('register')); ?>" method="POST" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-4">
                            <h2 class="text-xs font-bold uppercase tracking-widest text-zinc-500 border-b border-zinc-800 pb-2">
                                Details
                            </h2>
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email')); ?>"
                                    class="w-full px-4 py-2.5 bg-zinc-900 text-white border border-zinc-800 rounded-md focus:ring-2 focus:ring-white outline-none transition-all placeholder:text-zinc-600"
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <label class="text-sm font-medium text-zinc-300">Confirm Password</label>
                    ...
                    <script>
                        ...
                        Swal.fire({
                            ...
                            background: isDarkMode ? '#161615' : '#fff',
                            color: isDarkMode ? '#EDEDEC' : '#1b1b18',
                        });
                    </script>
                    <?php endif; ?>

                    <button type="submit" class="w-full py-4 bg-white text-black rounded-md font-bold hover:bg-zinc-200 transition-all active:scale-[0.98] shadow-lg">
                        Register
                    </button>
                </form>
            </div>
...
</html><?php /**PATH D:\wotlk\resources\views/auth/register.blade.php ENDPATH**/ ?>